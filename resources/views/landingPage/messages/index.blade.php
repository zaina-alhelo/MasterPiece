...
<section class="bg-light pt-4" >
    ...
    <div class="container-xl px-4 ">
        ...
        <div class="row">
            ...
            <div class="col-xl-8">
                <div class="card mb-4 shadow">
                    <div class="card-header bg-success text-white">رسائلك</div>
                            ...
                            @foreach ($messages as $message)
                                <div class="message mb-3" 
                                    ...
                                    @if($message->file_path)
                                        <a href="{{ asset('storage/' . $message->file_path) }}" target="_blank" class="btn btn-link">عرض المرفق</a>
                                    @endif
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="card mb-4 shadow">
                    <div class="card-header bg-success text-white">إرسال رسالة</div>
                    <div class="card-body">
