                            ...
                            <div class="national-item">
                                ...
                                <div class="national-content">
                                    <div class="national-info">
                                        <h5 class="text-white  mb-2">{{ $recipe->recipe_name }}</h5>
                                        <a href="{{ route('landing.recipes.show', $recipe->id) }}" class="btn-hover text-white"> اقرأ الوصفة <i class="fa fa-arrow-right ms-2"></i></a>
                                    </div>
                                </div>
                                <div class="national-plus-icon">
                                <a href="{{ route('landing.recipes.show', $recipe->id) }}" class="my-auto"><i class="fa fa-utensils fa-2x text-white"></i></a>
                                </div>
                            </div>
                        </div>
                        @endforeach
