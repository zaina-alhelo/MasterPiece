    ...
    <div class="d-inline-flex align-items-center" style="height: 45px;">
        @guest
            <!-- ظهور روابط Login و Register عند عدم تسجيل الدخول -->
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu rounded">
                    @if(Auth::user()->role === 'admin')
                        <a href="{{ route('dashboard') }}" class="dropdown-item"><i class="fas fa-tachometer-alt me-2"></i> Dashboard</a>
                    @endif
