@extends('land_page')
@section('title', 'وصفات صحية ')

@section('content')

<div class="container-fluid bg-breadcrumb">
    <div class="container text-center py-5" style="max-width: 900px;">
        <h3 class="text-white display-3 mb-4">وصفات صحية</h3>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 position-relative text-center" style="overflow: hidden;">
                        ...
                        <div class="card-img-overlay d-flex flex-column justify-content-center align-items-center text-white" style="background: rgba(0, 0, 0, 0.5);">
                            ...
                            <a href="{{ route('landing.recipe_cat.show', $category->id) }}" class="btn btn-success">عرض المزيد</a>
                        </div>
                    </div>
                </div>
            @endforeach
